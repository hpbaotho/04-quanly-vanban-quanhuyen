...
class listxml_modList extends Sys_DB_Connection {
	...
	public function getAllList($arrAllListType, $piIdListType, $piPage, $piNumRecordOnPage, $psFilterXmlString){							
		...
		if ($piIdListType > 0){
			...
			$psSqlString = $objSysLibXml->_xmlGetXmlTagValue($psXmlFileName,"list_of_object","list_sql");
			...
			$psSqlString = $objSysLibXml->_replaceTagXmlValueInSql($psSqlString, $psXmlFileName, 'list_of_object/table_struct_of_filter_form/filter_row_list/filter_row', $psFilterXmlString);
		//	echo 	$psSqlString;		
