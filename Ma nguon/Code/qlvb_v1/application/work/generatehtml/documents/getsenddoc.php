...
// Dinh nghia duong dan den thu vien cua Zend
	...
	$html .= "<col width='4%'><col width='15%'><col width='11%'><col width='40%'><col width='30%'>";
				...
				for($index = 0;$index < sizeof($arrresult);$index++){
					...
					$ssendDate					= $arrresult[$index]['C_SENT_DATE'] .'&nbsp;';		
					$snumber					= $arrresult[$index]['C_NUMBER'] .'&nbsp;';						
					...
					$sreceivedPlace				= $arrresult[$index]['C_RECEIVE_PLACE'].'&nbsp;';	
					...
					if($iOrder ==1){
						...
						if($sdocId == $arrresult[$index]['PK_SENT_DOCUMENT']){
								$html .='<input type="checkbox" id="chk_item_id" name="chk_item_id" onclick ="selectrow_dialog(this,\''.$documentId.'\',document.getElementById(\'hdn_doc_id\'))" checked value ="'.$arrresult[$index]['PK_SENT_DOCUMENT'].'" /></td>';//exit;
						}
						else 	$html .='<input type="checkbox" id="chk_item_id" name="chk_item_id" onclick ="selectrow(this)" checked value ="'.$arrresult[$index]['PK_SENT_DOCUMENT'].'" /></td>';
					}
					else{
					...
					$html .='<td onclick="set_hidden_dialog(this,document.getElementsByName(\'chk_item_id\'),\''.$documentId.'\',document.getElementById(\'hdn_doc_id\'));" align="center"  style="padding-left:3px;padding-right:3px;" class="normal_label" >'.$ssendDate.'</td>';													
					$html .='<td onclick="set_hidden_dialog(this,document.getElementsByName(\'chk_item_id\'),\''.$documentId.'\',document.getElementById(\'hdn_doc_id\'));" align="center"  style="padding-left:3px;padding-right:3px;" class="normal_label">'.$snumber.'/'.$ssymbol.'&nbsp;</td>';
					$html .='<td onclick="set_hidden_dialog(this,document.getElementsByName(\'chk_item_id\'),\''.$documentId.'\',document.getElementById(\'hdn_doc_id\'));" align="left" valign="middle"  style="padding-left:3px;padding-right:3px;" class="normal_label">'.$ssubject.'</td>';
					$html .='<td onclick="set_hidden_dialog(this,document.getElementsByName(\'chk_item_id\'),\''.$documentId.'\',document.getElementById(\'hdn_doc_id\'));" align="left" style="padding-left:3px;padding-right:3px;" class="normal_label">'.$sreceivedPlace.'</td>';
					$html .='</tr>';	
				}		
