...
// Dinh nghia duong dan den thu vien cua Zend
	...
	//echo $iCurentPage.'a'; exit;
	//echo $sfullTextSearch; exit;
	//Lay ID DON VI
	$iUnitId = $_REQUEST['iUnitId']; 
	//Lay tu dong so den VB 
	$arrresult = $objReceive ->DocReceivedGetAll($sOwnerId,$sfullTextSearch,$iCurentPage,$iRowOnPage,$sListID);
	...
	$html .= "<col width='4%'><col width='10%'><col width='10%'><col width='15%'><col width='30%'><col width='30%'>";
				...
				for($index = 0;$index < sizeof($arrresult);$index++){
					//Lay file dinh kem$objFunction->searchCharColor($this->sFullTextSearch,$arrSent[$index]['C_SENT_DATE']) .'&nbsp;';	
					...
					// so den
					$snum					= $objFunction->searchCharColor($sfullTextSearch,$arrresult[$index]['C_NUM']).'&nbsp;';		
					//ngay den
					...
					// Don vi xu ly
					$sprocesunit			= $objFunction->searchStringColor($sfullTextSearch,$arrresult[$index]['C_PROCESS_UNIT_NAME_LIST']).'&nbsp;';	
					...
					if($iOrder ==1){
						...
						$html .='<input type="checkbox" id="chk_item_id" name="chk_item_id" onclick ="selectrow(this)" checked value ="'.$arrresult[$index]['PK_RECEIVED_DOC'].'" /></td>';
					}else{
						$html = $html.'<tr class="'.$v_current_style_name.'">';
						$html .='<td align="center" style="padding-left:3px;padding-right:3px;" class="normal_label">';
					$html .='<input type="checkbox" id="chk_item_id" name="chk_item_id" onclick ="selectrow(this)" value ="'.$arrresult[$index]['PK_RECEIVED_DOC'].'" /></td>';
					}
					$html .='<td onclick="set_hidden_dialog(this,document.getElementsByName(\'chk_item_id\'),document.getElementById(\'hdn_object_id\'),\''.$documentId.'\',document.getElementById(\'hdn_doc_id\'));" align="center"  style="padding-left:3px;padding-right:3px;" class="normal_label" >'.$snum.'</td>';													
					$html .='<td onclick="set_hidden_dialog(this,document.getElementsByName(\'chk_item_id\'),document.getElementById(\'hdn_object_id\'),\''.$documentId.'\',document.getElementById(\'hdn_doc_id\'));" align="center"  style="padding-left:3px;padding-right:3px;" class="normal_label">'.$sreceivedDate.'&nbsp;</td>';
					$html .='<td onclick="set_hidden_dialog(this,document.getElementsByName(\'chk_item_id\'),document.getElementById(\'hdn_object_id\'),\''.$documentId.'\',document.getElementById(\'hdn_doc_id\'));" align="center" valign="middle"  style="padding-left:3px;padding-right:3px;" class="normal_label">'.$ssymbol.'</td>';
					$html .='<td onclick="set_hidden_dialog(this,document.getElementsByName(\'chk_item_id\'),document.getElementById(\'hdn_object_id\'),\''.$documentId.'\',document.getElementById(\'hdn_doc_id\'));" align="left" style="padding-left:3px;padding-right:3px;" class="normal_label">'.$ssubject.'</td>';
					$html .='<td onclick="set_hidden_dialog(this,document.getElementsByName(\'chk_item_id\'),document.getElementById(\'hdn_object_id\'),\''.$documentId.'\',document.getElementById(\'hdn_doc_id\'));" align="left" style="padding-left:3px;padding-right:3px;" class="normal_label">'.$sprocesunit.'</td>';
					$html .='</tr>';	
				}		
