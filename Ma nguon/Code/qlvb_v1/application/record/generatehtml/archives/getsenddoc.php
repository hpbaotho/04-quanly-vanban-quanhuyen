...
// Dinh nghia duong dan den thu vien cua Zend
	...
	$arrresult = $objRecordArchive ->DocRecordArchiveSentDocGetAll($sDocType,$sDocCate,$iYear,$sOwnerId,$sfullTextSearch,$iCurentPage,$iRowOnPage);
	//exit;
	...
	$html .= "<col width='4%'><col width='15%'><col width='10%'><col width='51%'><col width='20%'>";
				...
				for($index = 0;$index < sizeof($arrresult);$index++){
					...
					$sReceivePlace			= $objFunction->searchCharColor($sfullTextSearch,$arrresult[$index]['C_RECEIVE_PLACE']) .'&nbsp;';			
					...
					$html .='<input type="checkbox" id="chk_item_id" name="chk_item_id" onclick ="selectrow_docrelate(this)" value ="'.$arrresult[$index]['PK_SENT_DOC'].'" /></td>';
					$html .='<td onclick="set_hidden_docrelate(this,document.getElementsByName(\'chk_item_id\'),\''.$documentId.'\');" align="center"  style="padding-left:3px;padding-right:3px;" class="normal_label" >'.$ssendDate.'</td>';													
					$html .='<td onclick="set_hidden_docrelate(this,document.getElementsByName(\'chk_item_id\'),\''.$documentId.'\');" align="center"  style="padding-left:3px;padding-right:3px;" class="normal_label">'.$snumSymbol.'&nbsp;</td>';
					$html .='<td onclick="set_hidden_docrelate(this,document.getElementsByName(\'chk_item_id\'),\''.$documentId.'\');" align="left" valign="middle"  style="padding-left:3px;padding-right:3px;" class="normal_label">'.$ssubject.'</td>';
					$html .='<td onclick="set_hidden_docrelate(this,document.getElementsByName(\'chk_item_id\'),\''.$documentId.'\');" align="left" style="padding-left:3px;padding-right:3px;" class="normal_label">'.$sReceivePlace.'</td>';
					$html .='</tr>';	
				}		
