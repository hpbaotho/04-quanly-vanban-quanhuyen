...
abstract class Zend_View_Abstract implements Zend_View_Interface
{
     ...
     * @return $strHTML
     */
    public  function addEmptyRow($pCurrentRow,$pTotalRow,$pCurrentStyleName,$pTotalColumn) {    			
		//Dinh dang style
     ...
     */
     public  function GenerateHeaderTable($widthCols,$TitleCols,$delimitor) {       	
     ...
     * 		@return $strHTML
     */
    public  function generateSelectBoxPage($totalRow,$currentPage,$numRowOnPage,$actionUrl){
