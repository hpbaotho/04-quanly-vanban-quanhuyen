...
/*KHÁCH HÀNG SẼ THAY ĐỔI CÁC THÔNG TIN SAU************************************/
	private $merchant_id = '277';	// Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site
	
	private $secure_pass = 'ec0fe884450142e7'; // Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site
	
	private $business = 'sales@noithatonline.vn';
/*****************************************************************************/
    ...
    function get_code($order, $payment)
    {
        ...
        $url_cancel     = $GLOBALS['ecs']->url();
		  ...
		  $btn_baokim = 'Click để thanh toán ngay với Bảo Kim<a href="'.$url_baokim.'"><img src = "https://www.baokim.vn/application/uploads/buttons/btn_pay_now_3.png" /></a>';
