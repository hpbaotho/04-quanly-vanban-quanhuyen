	...
	$html .= "<col width='4%'><col width='10%'><col width='10%'><col width='15%'><col width='30%'><col width='30%'>";
				...
				for($index = 0;$index < sizeof($arrresult);$index++){
					...
					if($iOrder ==1){
						...
						if($sdocId == $arrresult[$index]['PK_RECEIVED_DOC']){
								$html .='<input type="checkbox" id="chk_item_id" name="chk_item_id" onclick ="selectrow_dialog(this,\''.$documentId.'\',document.getElementById(\'hdn_doc_id\'))" checked value ="'.$arrresult[$index]['PK_RECEIVED_DOC'].'" /></td>';//exit;
						}
						else 	$html .='<input type="checkbox" id="chk_item_id" name="chk_item_id" onclick ="selectrow(this)" checked value ="'.$arrresult[$index]['PK_RECEIVED_DOC'].'" /></td>';
					}
					else{
					...
					$html .='<td onclick="set_hidden_dialog(this,document.getElementsByName(\'chk_item_id\'),\''.$documentId.'\',document.getElementById(\'hdn_doc_id\'));" align="center"  style="padding-left:3px;padding-right:3px;" class="normal_label" >'.$snum.'</td>';													
					$html .='<td onclick="set_hidden_dialog(this,document.getElementsByName(\'chk_item_id\'),\''.$documentId.'\',document.getElementById(\'hdn_doc_id\'));" align="center"  style="padding-left:3px;padding-right:3px;" class="normal_label">'.$sreceivedDate.'&nbsp;</td>';
					$html .='<td onclick="set_hidden_dialog(this,document.getElementsByName(\'chk_item_id\'),\''.$documentId.'\',document.getElementById(\'hdn_doc_id\'));" align="center" valign="middle"  style="padding-left:3px;padding-right:3px;" class="normal_label">'.$ssymbol.'</td>';
					$html .='<td onclick="set_hidden_dialog(this,document.getElementsByName(\'chk_item_id\'),\''.$documentId.'\',document.getElementById(\'hdn_doc_id\'));" align="left" style="padding-left:3px;padding-right:3px;" class="normal_label">'.$ssubject.'</td>';
					$html .='<td onclick="set_hidden_dialog(this,document.getElementsByName(\'chk_item_id\'),\''.$documentId.'\',document.getElementById(\'hdn_doc_id\'));" align="left" style="padding-left:3px;padding-right:3px;" class="normal_label">'.$sprocesunit.'</td>';
					$html .='</tr>';	
				}		
