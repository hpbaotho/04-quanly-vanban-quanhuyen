...
function show_hide_div(){	
	...
	if( bChecked == true){
		// an hien thi tu server		
		document.getElementById('popupDialog').style.display= 'none';		
		document.getElementById('txt_xml_file_name').style.display= 'none';
		// hien thi tu client
		document.getElementById('C_XML_FILE_NAME').style.display= 'block';
	}else{
		//  hien thi tu server
			
		document.getElementById('popupDialog').style.display= 'block';
		
		document.getElementById('txt_xml_file_name').style.display= 'block';

		// an hien thi tu client
		document.getElementById('C_XML_FILE_NAME').style.display= 'none';
	}
