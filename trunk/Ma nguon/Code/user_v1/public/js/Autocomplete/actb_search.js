function actb(obj,ca,fa,fEnter,single,editable,sWebsitePart){
	...
	function actb_generate(){
		...
		for (i=0;i<actb_self.actb_keywords.length;i++){
			...
			if (j - 1 == actb_self.actb_lim && j < actb_total){
				...
				c.colspan = '2';
				c.align='center';
				c.innerHTML = "<img src='../../js/Autocomplete/" + sWebsitePart + "public/Images/DownArrow.gif'>";
				if (actb_self.actb_mouse){
					c.style.cursor = 'pointer';
	...
	function actb_remake(){
		...
		if (actb_rangeu > 1){
			...
			c.align='center';
			c.style.backgroundColor = '#FAFAFA'
			c.innerHTML = "<img src='../../js/Autocomplete/" + sWebsitePart + "public/Images/UpArrow.gif'>";
			if (actb_self.actb_mouse){
				c.style.cursor = 'pointer';
