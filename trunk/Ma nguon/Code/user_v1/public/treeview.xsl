...
<xsl:stylesheet version="1.0"  xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:php='remove'>
	...
	<xsl:variable name="path" select="/treeview/custom-parameters/param[@name='path']/@value"/>
		...
		<table border="0" cellspacing="0" cellpadding="0">
			<tr id="str_obj" >
				...
				<!--Neu cho hien cac nut-->	
					...
					<td valign="top" align="left" colspan="3">
					<a onclick="node_image_onclick(this,'{$show_control}','{$opening_node_img_name}','{$closing_node_img_name}',document.getElementById('hdn_list_parent_id'),'/Sys-user-v1/user/org/')" class="folder" >
