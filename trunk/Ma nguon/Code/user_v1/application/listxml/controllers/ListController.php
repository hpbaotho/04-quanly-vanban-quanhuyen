...
class listxml_ListController extends  Zend_Controller_Action {
	...
	public function init(){
		...
		$this->view->LoadAllFileJsCss = Sys_Publib_Library::_getAllFileJavaScriptCss('','js','list/jsList.js,jquery-1.4.3.js,jQuery.equalHeights.js',',','js');										
		/* Ket thuc*/
	...
	public function indexAction(){
		...
		if (count($arrAllList) > 0){			
			...
			$this->view->generateHtmlSelectBoxPage = Sys_Publib_Library::_generateNumberPageIntoSelectbox($psNumberRecord, $piCurrentPage, $piNumRowOnPage, 'index') . "&nbsp;" . Sys_Publib_Library::_generateChangeRecordNumberPage($piNumRowOnPage,"index");
		}		
	...
	public function addAction(){
		...
		if($this->_request->isPost()){				
			...
			$arrParameter = array(									
									...
									'PK_LIST'						=>0,
									'C_CODE'						=>trim($ojbSysLib->_replaceBadChar($objFilter->filter($arrInput['C_CODE']))),
									'C_NAME'						=>trim($ojbSysLib->_replaceBadChar($objFilter->filter($arrInput['C_NAME']))),
